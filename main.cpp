...
int main(int argc, char* argv[])
{
    ...
    //rt.addObject<Plane>(vec3<>(10.f, 0.f, 0.f), vec3<>(-1.f, 0.f, 0.f), vec3<>(0.f, 0.f, 1.f), 0.0f);
    //rt.addObject<Plane>(vec3<>(-10.f, 0.f, 0.f), vec3<>(1.f, 0.f, 0.f), vec3<>(0.f, 0.f, 1.f), 0.0f);
    //rt.addObject<Plane>(vec3<>(0.f, 3.f, 0.f), vec3<>(0.f, -1.f, 0.f), vec3<>(0.f, 0.f, 0.f), 1.f);
    //rt.addObject<Plane>(vec3<>(0.f, -3.f, 0.f), vec3<>(0.f, 1.f, 0.f), vec3<>(0.f, 0.f, 0.f), 1.f);

    rt.addObject<Plane>(vec3<>(0.f, 0.f, 10.f), vec3<>(0.f, 0.f, 1.f), vec3<>(0.f, 0.f, 0.f), 1.f);
    rt.addObject<Plane>(vec3<>(-3.f, 0.f, 5.f), vec3<>(1.f, 0.f, 0.2f), vec3<>(), 1.f);
    rt.addObject<Plane>(vec3<>(3.f, 0.f, 5.f), vec3<>(1.f, 0.f, 0.2f), vec3<>(), 1.f);
    ...
    for (int i = 0; i < 100; ++i)
    {
        ...
        rt.addPointLight(pos, 0.9f, vec3<>((rand()%100/100.f), (rand()%100/100.f), (rand()%100/100.f)));
    }
    //rt.setAmbientLight(vec3<>(0.5f, 0.5f, 0.5f));
